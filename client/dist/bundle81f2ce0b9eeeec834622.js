    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          (0,idb__WEBPACK_IMPORTED_MODULE_2__.openDB)("jate", 1, {
...
var putDb = /*#__PURE__*/function () {
  var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(id, content) {
    var textDB, tx, store, request, result;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          textDB = _context2.sent;
          // Create a new transaction and specify the database and data privileges.
          tx = textDB.transaction("jate", "readwrite"); // open up the object store.
          store = tx.objectStore("jate"); // Use the .put() method and pass in content.
          request = store.put({
            id: id,
            content: content
          }); // Confirm the request.
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0,idb__WEBPACK_IMPORTED_MODULE_2__.openDB)("jate", 1);
        case 3:
          textDB = _context3.sent;
          // Create a new transaction and specify the database and data privileges.
          tx = textDB.transaction("jate", "readonly"); // Open up the desired object store.
          store = tx.objectStore("jate"); // method to get all data in the database.
          request = store.getAll(); // Confirm the request.
          _context3.next = 9;
          return request;
        case 9:
...
var _default = /*#__PURE__*/(0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(function _default() {
  ...
  if (localStorage.getItem("content") === undefined || localStorage.getItem("content") === null) {
    ...
    localStorage.setItem("content", _header__WEBPACK_IMPORTED_MODULE_3__.header);
    (0,_database__WEBPACK_IMPORTED_MODULE_2__.putDb)(1, localStorage.getItem("content"));
  ...
  (0,_database__WEBPACK_IMPORTED_MODULE_2__.getDb)().then(function (data) {
    ...
    if (!data[0].content || !localStorage.getItem("content")) {
      ...
      _this.editor.setValue(_header__WEBPACK_IMPORTED_MODULE_3__.header);
    } else if (regExp.test(data[0].content)) {
      console.log("This was triggered: regExp.test(data[0].content ) ");
      _this.editor.setValue(data[0].content);
      ...
      _this.editor.setValue(localData);
    }
    _this.editor.setCursor(_this.editor.lastLine());
  });
...
/******/ })()
;
//# sourceMappingURL=bundle81f2ce0b9eeeec834622.js.map